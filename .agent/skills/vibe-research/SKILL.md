...
After confirmation, generate a tailored research prompt. Use `search_web` to gather current information about:
...
>
> **Next Step:** Run `/vibe-step2` to create your Product Requirements Document (PRD).
