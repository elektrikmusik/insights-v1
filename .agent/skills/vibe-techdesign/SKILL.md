...
3. If no PRD exists, suggest running `/vibe-step2` first
...
>
> **Next Step:** Run `/vibe-step4` to generate your `AGENTS.md` and AI configuration files.
